...
final class ConfiguratorCoreTest extends TestCase
{
    ...
    public function testUnitFieldValueAndQuantitySemantics(): void
    {
        ...
        $result = $this->calculateWithRules(new ConfiguratorConfiguration('generic', 1000, 'EUR', 'DE_WEB'), $model, [$base]);
    ...
    public function testUnitBreakdownMultipliersRemainMathematicallyConsistent(): void
    {
        ...
        $result = $this->calculateWithRules(new ConfiguratorConfiguration('generic', 1000, 'EUR', 'DE_WEB'), $model, [$rule]);
        self::assertSame(1000, $result->breakdown[0]->multiplier);
        self::assertSame(10000, $result->breakdown[0]->amount);
    ...
    public static function invalidTypedSelections(): iterable
    {
        ...
        yield 'canonical integer string' => [FieldType::INTEGER, '3', true];
