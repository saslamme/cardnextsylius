...
{
    public function __construct(private ConfiguratorPageResolver $resolver, private ChannelContextInterface $channelContext, private LocaleContextInterface $localeContext, private Environment $twig)
    {
    }
    ...
    public function __invoke(string $configuratorPath): Response
    {
        ...
        if ($result === null) {
            throw new NotFoundHttpException('No configurator matches this localized path.');
        }
