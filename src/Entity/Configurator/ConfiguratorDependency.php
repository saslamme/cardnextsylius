...
use App\Enum\Configurator\{DependencyEffect,DependencyOperator};
...
class ConfiguratorDependency
{
    ...
    #[ORM\ManyToOne(targetEntity:Configurator::class, inversedBy: 'dependencies'),ORM\JoinColumn(nullable:false, onDelete:'CASCADE')] private Configurator $configurator;
    #[ORM\ManyToOne(targetEntity:ConfiguratorField::class),ORM\JoinColumn(nullable:false, onDelete:'CASCADE')] private ConfiguratorField $sourceField;
    #[ORM\Column(enumType:DependencyOperator::class, length:40)] private DependencyOperator $operator;
    #[ORM\Column(type:'json')] private array $expectedValues = [];
    #[ORM\ManyToOne(targetEntity:ConfiguratorField::class),ORM\JoinColumn(nullable:true, onDelete:'CASCADE')] private ?ConfiguratorField $targetField = null;
    #[ORM\ManyToOne(targetEntity:ConfiguratorValue::class),ORM\JoinColumn(nullable:true, onDelete:'CASCADE')] private ?ConfiguratorValue $targetValue = null;
    #[ORM\Column(enumType:DependencyEffect::class, length:20)] private DependencyEffect $effect;
    #[ORM\Column] private int $priority = 0;
    #[ORM\Column(options:['default' => true])] private bool $enabled = true;
    /** @param list<string|int|bool> $expected */ public function __construct(Configurator $c, ConfiguratorField $source, DependencyOperator $op, array $expected, DependencyEffect $effect)
    {
