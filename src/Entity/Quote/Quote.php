...
class Quote
{
    ...
    #[ORM\Column(name: 'customer_company', length: 255)]
    private string $customerCompany = '';

    #[ORM\Column(name: 'customer_contact_name', length: 255)]
    private string $customerContactName = '';

    #[ORM\Column(name: 'customer_email', length: 254)]
    ...
    #[ORM\Column(name: 'customer_street', length: 255, nullable: true)]
    private ?string $customerStreet = null;

    #[ORM\Column(name: 'customer_house_number', length: 32, nullable: true)]
    private ?string $customerHouseNumber = null;

    #[ORM\Column(name: 'customer_postal_code', length: 32, nullable: true)]
    private ?string $customerPostalCode = null;

    #[ORM\Column(name: 'customer_city', length: 128, nullable: true)]
    private ?string $customerCity = null;

    #[ORM\Column(name: 'customer_country_code', length: 2, nullable: true)]
    private ?string $customerCountryCode = null;

    #[ORM\Column(name: 'customer_number', length: 64, nullable: true)]
    private ?string $customerNumber = null;

    #[ORM\Column(name: 'customer_phone', length: 64, nullable: true)]
    private ?string $customerPhone = null;

    #[ORM\Column(name: 'project_reference', length: 255, nullable: true)]
    private ?string $projectReference = null;

    #[ORM\Column(name: 'customer_purchase_order_number', length: 128, nullable: true)]
    private ?string $customerPurchaseOrderNumber = null;

    #[ORM\Column(name: 'quote_date', type: Types::DATE_IMMUTABLE, nullable: true)]
    ...
    #[ORM\Column(name: 'first_sent_at', type: Types::DATETIME_IMMUTABLE, nullable: true)]
    ...
    #[ORM\Column(name: 'send_count', options: ['default' => 0])]
    private int $sendCount = 0;

    #[ORM\Column(name: 'first_viewed_at', type: Types::DATETIME_IMMUTABLE, nullable: true)]
    private ?\DateTimeImmutable $firstViewedAt = null;

    #[ORM\Column(name: 'last_viewed_at', type: Types::DATETIME_IMMUTABLE, nullable: true)]
    private ?\DateTimeImmutable $lastViewedAt = null;

    #[ORM\Column(name: 'view_count', options: ['default' => 0])]
    private int $viewCount = 0;

    #[ORM\Column(name: 'accepted_at', type: Types::DATETIME_IMMUTABLE, nullable: true)]
    private ?\DateTimeImmutable $acceptedAt = null;

    #[ORM\Column(name: 'accepted_by_name', length: 255, nullable: true)]
    private ?string $acceptedByName = null;

    #[ORM\Column(name: 'rejected_at', type: Types::DATETIME_IMMUTABLE, nullable: true)]
    private ?\DateTimeImmutable $rejectedAt = null;

    #[ORM\Column(name: 'rejected_by_name', length: 255, nullable: true)]
    private ?string $rejectedByName = null;

    #[ORM\Column(name: 'rejection_reason', type: Types::TEXT, nullable: true)]
    private ?string $rejectionReason = null;

    #[ORM\Column(name: 'default_tax_rate', options: ['default' => 0])]
    private int $defaultTaxRate = 0;

    #[ORM\Column(name: 'tax_note', type: Types::TEXT, nullable: true)]
    private ?string $taxNote = null;

    #[ORM\Column(name: 'valid_until', type: Types::DATE_IMMUTABLE, nullable: true)]
    private ?\DateTimeImmutable $validUntil = null;

    #[ORM\Column(name: 'delivery_terms', type: Types::TEXT, nullable: true)]
    ...
    #[ORM\Column(name: 'discount_total')]
    private int $discountTotal = 0;

    #[ORM\Column(name: 'shipping_total')]
    private int $shippingTotal = 0;

    #[ORM\Column(name: 'service_total')]
    private int $serviceTotal = 0;

    #[ORM\Column(name: 'tax_total')]
    private int $taxTotal = 0;

    #[ORM\Column(name: 'grand_total')]
    ...
    #[ORM\ManyToOne(targetEntity: AdminUser::class), ORM\JoinColumn(name: 'created_by_id', nullable: true, onDelete: 'SET NULL')]
    private ?AdminUser $createdBy = null;

    #[ORM\ManyToOne(targetEntity: AdminUser::class), ORM\JoinColumn(name: 'updated_by_id', nullable: true, onDelete: 'SET NULL')]
    ...
    public function setQuoteRequest(QuoteRequest $value): void
    {
    ...
    public function transitionTo(QuoteStatus $value): void
    {
        if (!$this->status->canTransitionTo($value)) {
            throw new \DomainException('Invalid quote status transition.');
        } $this->status = $value;
    }

    /** @internal Initial state is only set by factories/ORM. */
    public function setStatus(QuoteStatus $value): void
    {
        $this->status = $value;
    }
    ...
    public function setChannelCode(string $value): void
    {
    ...
    public function setLocaleCode(string $value): void
    {
    ...
    public function setCustomerCompany(string $value): void
    {
    ...
    public function setCustomerContactName(string $value): void
    {
    ...
    public function setCustomerEmail(string $value): void
    {
    ...
    public function setCustomerStreet(?string $v): void
    {
        $this->customerStreet = $v;
    }
    ...
    public function setCustomerHouseNumber(?string $v): void
    {
        $this->customerHouseNumber = $v;
    }
    ...
    public function setCustomerPostalCode(?string $v): void
    {
        $this->customerPostalCode = $v;
    }
    ...
    public function setCustomerCity(?string $v): void
    {
        $this->customerCity = $v;
    }
    ...
    public function setCustomerCountryCode(?string $v): void
    {
        $this->customerCountryCode = $v;
    }
    ...
    public function setCustomerPhone(?string $v): void
    {
    ...
    public function setQuoteDate(?\DateTimeImmutable $v): void
    {
        $this->quoteDate = $v;
    }
    ...
    public function setReadyAt(?\DateTimeImmutable $v): void
    {
        $this->readyAt = $v;
    }
    ...
    public function recordSent(\DateTimeImmutable $now): void
    {
        if (!in_array($this->status, [QuoteStatus::Ready, QuoteStatus::Sent], true)) {
            throw new \DomainException('Dieses Angebot kann nicht versendet werden.');
        } if ($this->firstSentAt === null) {
            $this->firstSentAt = $now;
        } $this->lastSentAt = $now;
        ++$this->sendCount;
        if ($this->status === QuoteStatus::Ready) {
            $this->transitionTo(QuoteStatus::Sent);
        }
    }
    ...
    public function recordViewed(\DateTimeImmutable $now): bool
    {
        $first = $this->firstViewedAt === null;
        if ($first) {
    ...
    public function accept(string $name, \DateTimeImmutable $now): void
    {
        $name = trim($name);
        if ($name === '' || mb_strlen($name) > 255) {
            throw new \InvalidArgumentException('Invalid name.');
        } $this->transitionTo(QuoteStatus::Accepted);
        $this->acceptedAt = $now;
    ...
    public function reject(string $name, ?string $reason, \DateTimeImmutable $now): void
    {
        $name = trim($name);
        $reason = $reason === null ? null : trim($reason);
        if ($name === '' || mb_strlen($name) > 255 || ($reason !== null && mb_strlen($reason) > 2000)) {
            throw new \InvalidArgumentException('Invalid rejection data.');
        } $this->transitionTo(QuoteStatus::Rejected);
        $this->rejectedAt = $now;
        $this->rejectedByName = $name;
        $this->rejectionReason = $reason === '' ? null : $reason;
    }

    public function isExpired(?\DateTimeImmutable $now = null): bool
    {
        return $this->validUntil !== null && ($now ?? new \DateTimeImmutable())->setTime(0, 0) > $this->validUntil->setTime(0, 0);
    }
    ...
    public function setDefaultTaxRate(int $v): void
    {
        if ($v < 0) {
            throw new \InvalidArgumentException('Tax rate cannot be negative.');
        } $this->defaultTaxRate = $v;
    }

    public function getTaxNote(): ?string
    {
        return $this->taxNote;
    }

    public function setTaxNote(?string $v): void
    {
        $this->taxNote = $v;
    }
    ...
    public function setValidUntil(?\DateTimeImmutable $value): void
    {
    ...
    public function setDeliveryTerms(?string $value): void
    {
    ...
    public function setPaymentTerms(?string $value): void
    {
    ...
    public function setCustomerNote(?string $value): void
    {
    ...
    public function setInternalNote(?string $value): void
    {
    ...
    public function setSubtotal(int $value): void
    {
        $this->subtotal = $value;
    }
    ...
    public function setDiscountTotal(int $value): void
    {
    ...
    public function setShippingTotal(int $value): void
    {
        $this->shippingTotal = $value;
    }

    public function getServiceTotal(): int
    {
        return $this->serviceTotal;
    }

    public function setServiceTotal(int $value): void
    {
    ...
    public function setTaxTotal(int $value): void
    {
        $this->taxTotal = $value;
    }
    ...
    public function setGrandTotal(int $value): void
    {
    ...
    public function setCreatedBy(?AdminUser $value): void
    {
    ...
    public function setUpdatedBy(?AdminUser $value): void
    {
    ...
    public function getConvertedToOrderAt(): ?\DateTimeImmutable
    {
        return $this->convertedToOrderAt;
    }

    public function getConvertedToOrderBy(): ?AdminUser
    {
        return $this->convertedToOrderBy;
    }

    public function markConvertedToOrder(Order $order, ?AdminUser $admin, \DateTimeImmutable $now): void
    {
        if ($this->order !== null) {
            throw new \DomainException('Dieses Angebot wurde bereits in eine Bestellung umgewandelt.');
        }
        $this->order = $order;
        $this->convertedToOrderBy = $admin;
        $this->convertedToOrderAt = $now;
    }
