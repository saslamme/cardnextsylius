...
final class CmsDownload
{
    ...
    #[ORM\ManyToMany(targetEntity: Channel::class)] #[ORM\JoinTable(name: 'cardnext_cms_download_channel')] private Collection $channels;
    /** @var Collection<int, Product> */
    #[ORM\ManyToMany(targetEntity: Product::class)] #[ORM\JoinTable(name: 'cardnext_cms_download_product')] private Collection $products;
    ...
    public function getTranslations():Collection{return $this->translations;} public function addTranslation(CmsDownloadTranslation $v):void{if(!$this->translations->contains($v)){$this->translations->add($v);$v->setDownload($this);}} public function getTranslation(string $locale):?CmsDownloadTranslation{foreach($this->translations as $t)if($t->getLocale()===$locale)return $t;return null;}
