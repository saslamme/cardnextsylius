...
#[ORM\Entity] #[ORM\Table(name:'cardnext_cms_download_translation')] #[ORM\UniqueConstraint(name:'uniq_download_locale',columns:['download_id','locale'])] #[ORM\Index(name:'idx_cms_dt_download', columns:['download_id'])]
