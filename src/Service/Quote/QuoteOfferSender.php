...
final class QuoteOfferSender
{
 ...
 public function send(Quote $quote): void
 {
  ...
  if(!$user instanceof ShopUser || !$user->isEnabled()) throw new \DomainException('Das Angebot kann nicht versendet werden. Für diesen Kunden existiert noch kein aktives Kundenkonto.');
