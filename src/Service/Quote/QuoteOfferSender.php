...
{
 public function __construct(private EntityManagerInterface $em,private QuotePublicAccessTokenManager $tokens,private QuotePdfRenderer $pdf,private QuoteOfferMailer $mailer,private RouterInterface $router){}
 public function send(Quote $quote): void
 {
  ...
  $url=$this->router->generate('cardnext_shop_quote_public',['_locale'=>$quote->getLocaleCode(),'number'=>$quote->getNumber(),'version'=>$quote->getVersion(),'token'=>$token],UrlGeneratorInterface::ABSOLUTE_URL);
